...
// Ícone de Download SVG simples e leve (Idêntico ao estilo do Figma)
const DownloadIcon = () => (
          ...
          {downloadsMock.map((item) => (
            <div 
              ...
              style={{
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'space-between', // Joga o 'Abrir' para a extrema direita
                padding: '16px 24px', // Padding interno confortável
                background: '#FFFFFF',
                borderRadius: '16px', // Bordas mais arredondadas igual ao Figma
            ...
            >
              {/* Ícone e Textos (Lado esquerdo) */}
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                <div style={{ 
                  width: '56px', height: '56px', // Ícone um pouco maior igual ao Figma
                  background: '#EFF6FF', // Azul claro de fundo
                  borderRadius: '12px', 
              ...
              {/* Botão Abrir (Lado direito - Verde do Figma) */}
              <button 
                style={{
                  background: 'none',
                  border: 'none',
                  color: '#059669', // Verde Exato do Figma
                  fontWeight: '600',
                  fontSize: '15px',
                  cursor: 'pointer',
                  padding: '8px',
