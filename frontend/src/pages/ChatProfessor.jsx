...
const contatosMock = [
  { id: 1, nome: '9º Ano A (Turma)', materia: 'Grupo da Turma', online: true, hora: '10:45', cor: '#E0F2FE', textoCor: '#0284C7' },
  { id: 2, nome: 'Coordenação Pedagógica', materia: 'Gestão Escolar', online: false, hora: 'Ontem', cor: '#FCE7F3', textoCor: '#DB2777' },
  { id: 3, nome: 'João Pedro', materia: 'Aluno - 1º Ano B', online: true, hora: 'Seg', cor: '#FEF3C7', textoCor: '#D97706' },
  { id: 4, nome: 'Maria Silva', materia: 'Responsável (João Pedro)', online: false, hora: 'Sex', cor: '#DCFCE7', textoCor: '#15803D' },
]
...
export default function ChatProfessor() {
  ...
  const [mensagens, setMensagens] = useState([
    { id: 1, remetente: 'outro', texto: 'Professor, o trabalho sobre equações pode ser entregue em dupla?', hora: '10:40' },
    { id: 2, remetente: 'eu', texto: 'Olá! Pode sim, desde que o nome de ambos esteja na capa do trabalho.', hora: '10:45' }
  ])
