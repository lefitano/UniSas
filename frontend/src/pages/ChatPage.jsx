...
// Mocks de Contatos atualizados para bater com o Figma
const contatosMock = [
  { id: 1, nome: 'Prof. Carlos Lima', materia: 'Professor(a) de Matemática', online: true, hora: '10:32', cor: '#E0F2FE', textoCor: '#0284C7' },
  { id: 2, nome: 'Profª. Ana Souza', materia: 'Professor(a) de Português', online: false, hora: 'Ontem', cor: '#FCE7F3', textoCor: '#DB2777' },
  { id: 3, nome: 'Coordenação', materia: 'Secretaria Escolar', online: true, hora: 'Seg', cor: '#FEF3C7', textoCor: '#D97706' },
]
...
export default function ChatPage() {
  ...
  // 1. ALTERAÇÃO AQUI: Inicia como null para não abrir nenhuma conversa direto
  const [contatoAtivo, setContatoAtivo] = useState(null)
  
  const [novaMensagem, setNovaMensagem] = useState('')
  const [busca, setBusca] = useState('')
  
  // Mock do histórico de mensagens baseado no Figma
  const [mensagens, setMensagens] = useState([
    { id: 1, remetente: 'outro', texto: 'Olá, turma! A lista de exercícios já está disponível.', hora: '10:30' },
    { id: 2, remetente: 'eu', texto: 'Professor, a questão 4 tem duas respostas corretas?', hora: '10:32' }
  ])
  ...
  return (
    <div className={styles.pagina} style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, padding: '24px 32px 32px 32px', boxSizing: 'border-box', display: 'flex', gap: '24px', overflow: 'hidden' }}>
        ...
        <div style={{ 
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '12px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
            {contatosFiltrados.map(contato => {
              // Verifica se tem contato ativo usando optional chaining (?.)
              ...
              return (
                <div 
                  ...
                  style={{
                    ...
                    background: isAtivo ? '#F4F0FF' : 'transparent', // Roxo super claro se ativo
                  }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div style={{ 
                      ...
                      background: contato.cor, color: contato.textoCor,
                      display: 'flex', alignItems: 'center', justifyContent: 'center', 
                      fontWeight: '700', fontSize: '16px', position: 'relative' 
                    }}>
                    ...
                    <div>
                      ...
                      <p style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#64748B' }}>{contato.materia.split(' de ')[1] || contato.materia}</p>
                    </div>
                  </div>
        ...
        {/* 2. LADO DIREITO: Verificação se há um contato selecionado */}
        {contatoAtivo ? (
          /* SE TEM CONTATO ATIVO -> Mostra o chat normalmente */
          ...
          /* SE NÃO TEM CONTATO ATIVO -> Mostra a tela inicial de "Selecione uma conversa" */
